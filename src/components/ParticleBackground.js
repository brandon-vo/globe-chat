...
function ParticleBackground() {
    return (
        <Particles className="absolute w-full h-full" options={ParticleConfig}></Particles>
    )
}

function DarkParticleBackground() {
    return (
        <Particles className="absolute w-full h-full" options={DarkParticleConfig}></Particles>
    )
}
